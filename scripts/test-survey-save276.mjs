...
async function scenario(online,callbackName){let calls=0,queued=0,saved=0;
 ...
 const storage={enqueueSurveySave:async()=>{},removeQueuedSurveySave:async()=>{},markQueuedSurveyPending:async()=>{},markQueuedSurveyAttention:async()=>{},definitiveSurveySaveError:()=>false};
