...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.14.0 PRODUCT BOUNDARIES =====',
    ...
    '- Project Manager and Area Focal Person database authorization now exists; dedicated project-team/workspace UI remains the next 2.14.x step.',
    '',
    '===== DATABASE BASELINE =====',
    ...
    '2.14.x — Project Team operational UI and workspace wiring.',
    'Use the 2.14.0 project staff / collection-geography authorization foundation for Project Team management, project-manager recruitment and focal monitoring screens.',
