...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.36.0 PRODUCT BOUNDARIES =====',
    ...
    '- 2.36.0 adds no database migration and was built directly on the validated 2.31.0 baseline. Planned scopes previously labelled 2.32-2.35 are not present and must not later ship with a lower package version.',
    ...
    'FieldLance 2.36.0 adds canonical URL routing, deep links, workspace history and mobile Field Worker primary navigation without changing backend authority.',
    'Future releases must use versions greater than 2.36.0. The previously planned 2.32-2.35 scopes remain deferred and should be renumbered when implemented.',
