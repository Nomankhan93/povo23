...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.15.1 PRODUCT BOUNDARIES =====',
    ...
    '2.16 — Recruitment Targets & Project Compensation should connect approved-response targets, recruitment capacity and existing immutable payable primitives without creating a second payable engine.',
