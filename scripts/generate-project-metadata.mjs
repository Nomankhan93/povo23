...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.19.5 PRODUCT BOUNDARIES =====',
    ...
    '- 2.19.4 stabilized the frontend foundation. 2.19.5 completes the user-facing FieldLance rebrand and product positioning while preserving historical database identifiers and compatibility.',
    ...
    '2.19.5 establishes the final FieldLance identity before screenshot-driven UI/UX work; large AppShell/routing refactors remain deferred until concrete UX issues are reviewed.',
