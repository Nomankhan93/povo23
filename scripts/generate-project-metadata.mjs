...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.19.6 PRODUCT BOUNDARIES =====',
    ...
    '- 2.19.4 stabilized the frontend foundation. 2.19.5 completed the user-facing FieldLance rebrand. 2.19.6 adds the migration-free visual-system/navigation foundation while preserving historical database identifiers and compatibility.',
    ...
    '2.19.6 establishes the shared FieldLance visual/navigation foundation. The next screen-level UI phase is 2.19.7 Field Worker Marketplace UX; routing/database/authorization redesign remains out of scope unless a concrete workflow requires it.',
