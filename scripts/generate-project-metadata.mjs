...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.36.1 PRODUCT BOUNDARIES =====',
    ...
    '- 2.36.0 added no database migration and was built directly on the validated 2.31.0 baseline. 2.36.1 adds one forward moderation/self-publication migration. Planned scopes previously labelled 2.32-2.35 are not present and must not later ship with a lower package version.',
    ...
    'FieldLance 2.36.1 makes Partner Organization project/template publication self-service and moves FieldLance to post-publication moderation while preserving the 2.36 routing foundation.',
    'Future releases must use versions greater than 2.36.1. The previously planned 2.32-2.35 scopes remain deferred and should be renumbered when implemented.',
    'The next planned feature phase is 2.37 Workforce Scheduling, Availability, Capacity & Assignment Conflict Control; do not reintroduce project/template pre-approval as part of scheduling work.',
