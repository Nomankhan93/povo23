...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.37.0 PRODUCT BOUNDARIES =====',
    ...
    '- 2.36.0 added no database migration and was built directly on the validated 2.31.0 baseline. 2.36.1 adds one forward moderation/self-publication migration and 2.37.0 adds one forward workforce-scheduling migration. Planned scopes previously labelled 2.32-2.35 are not present and must not later ship with a lower package version.',
    ...
    'FieldLance 2.37.0 adds privacy-preserving workforce scheduling and assignment conflict control on top of the 2.36 routing and 2.36.1 self-publication/moderation foundation.',
    'Future releases must use versions greater than 2.37.0. The previously planned 2.32-2.35 scopes remain deferred and should be renumbered when implemented.',
    'The next planned feature phase is 2.38 Attendance, Timesheets & Location Operations. Keep continuous/background tracking out of scope; location evidence should be explicit and session/assignment-bound.',
