...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.22.0 PRODUCT BOUNDARIES =====',
    ...
    '2.20.0 completes the Field Worker daily workspace, 2.21.0 the Organization workspace, 2.22.0 the FieldLance Staff Operations Home, 2.23.0 the shared Tasks / SLA / Escalation Center, 2.24.0 the Notifications & Communication Center, and 2.25.0 the Earnings / Wallet / Withdrawal UX.',
    'The next development phase is 2.26 Verified Work History, Reputation & Certificates. Keep verified work history assignment-backed and do not introduce self-edited reputation evidence.',
