...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.19.8 PRODUCT BOUNDARIES =====',
    ...
    '- 2.19.4 stabilized the frontend foundation. 2.19.5 completed the user-facing FieldLance rebrand. 2.19.6 added the visual-system/navigation foundation. 2.19.7 redesigns Partner NGO onboarding. 2.19.8 redesigns the workforce marketplace UX around one discover/apply/select/offer/accept/active lifecycle without replacing backend authorization.',
    ...
    '2.19.8 completes the first Workforce Marketplace UX pass for both Field Worker and Organization recruitment views while preserving existing open-opportunity/application/assignment authorization and compensation snapshots.',
    'The next screen-level UI phase is Organization Workspace UX: dashboard, projects, surveys, beneficiaries, workforce and operational analytics. Do not replace stable recruitment/payment/case backends merely for presentation consistency.',
