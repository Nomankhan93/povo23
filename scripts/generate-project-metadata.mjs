...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.14.1 PRODUCT BOUNDARIES =====',
    ...
    '- Project Manager and Area Focal Person authorization now has dedicated project-team and project-scoped workspace UI; broad NGO administration remains separate.',
    '',
    '===== DATABASE BASELINE =====',
    ...
    '2.14.x — Continue project operational workflow stabilization on the 2.14.1 scoped workspace baseline.',
    'Use the 2.14 project staff / collection-geography authorization foundation for project-manager and focal monitoring screens.',
    'Do not widen broad NGO directory, template, canonical, sharing or finance access for project-scoped staff.',
    '',
