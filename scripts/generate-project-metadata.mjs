...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '2.20.0 completes the Field Worker daily workspace, 2.21.0 the Organization workspace, 2.22.0 the FieldLance Staff Operations Home, 2.23.0 the shared Tasks / SLA / Escalation Center, and 2.24.0 the Notifications & Communication Center.',
    'The next development phase is 2.25 Earnings, Wallet & Withdrawal UX. Reuse the frozen payment/payable core; do not invent live provider behavior without official credentials.',
