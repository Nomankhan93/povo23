...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.19.0 PRODUCT BOUNDARIES =====',
    '- One personal POEM account can access multiple authorized workspaces.',
    '- 2.19.0 adds project/person-scoped beneficiary cases and assistance requests between assessed needs and delivered assistance; it does not create a second registry or delivery ledger.',
    '- Case intake requires approved survey provenance; one assessed need can belong to only one active case at a time.',
    '- POEM survey authority, NGO Admin and Project Manager manage cases/submit requests; only NGO Admin / POEM survey authority approve or reject requests. Area Focal is outside this boundary in 2.19.0.',
    '- Assistance-request approval means approved for planning only and never creates assistance_entries, payment, eligibility or impact claims.',
    ...
    '2.19.1 — Assistance Approval & Distribution Planning should consume approved 2.19.0 requests and create explicit plans before any delivered-assistance entry is recorded.',
    '2.19.2 should mature assistance-ledger / duplicate-support controls using canonical identity and controlled sharing without exposing broad cross-NGO beneficiary data.',
