...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.21.0 PRODUCT BOUNDARIES =====',
    ...
    '2.20.0 completes the dedicated Field Worker daily workspace. 2.21.0 completes the first dedicated Organization daily workspace: project/recruitment/survey/case/assistance/payable summaries remain read-only views over existing authoritative sources.',
    'The next screen-level UI phase is 2.22 FieldLance Staff Operations UX. Do not replace stable recruitment/payment/case backends merely for presentation consistency.',
