...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.16.1 PRODUCT BOUNDARIES =====',
    ...
    '2.17 — Project Funding & Financial Ledger should add central immutable/double-entry project funding and reservation/commitment/spend accounting without replacing the existing worker payable subledger.',
