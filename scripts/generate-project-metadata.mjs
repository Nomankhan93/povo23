...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.15.0 PRODUCT BOUNDARIES =====',
    ...
    '- Active NGO Admins can now create organization-owned survey-template drafts, submit/resubmit them for POEM review and use immutable approved NGO template versions.',
    '- POEM survey managers retain direct POEM template publication and receive a guarded NGO template review queue with changes-request/reject/approve decisions.',
    '',
    '===== DATABASE BASELINE =====',
    ...
    '2.15.1 — NGO Project Self-Service should stage NGO project requests separately and materialize approval into the existing survey_projects operational table.',
