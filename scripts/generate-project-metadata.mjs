...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.39.0 PRODUCT BOUNDARIES =====',
    ...
    'FieldLance 2.39.0 adds explicit case ownership, immutable handoff history, bounded My Cases / My Follow-ups and geography-scoped delegated Area Focal operations on top of the existing 2.19 case/follow-up and 2.23 Task Center systems.',
    'Future releases must use versions greater than 2.39.0. The previously planned 2.32-2.35 scopes remain deferred and should be renumbered when implemented.',
    'The next planned feature phase is 2.40 Field Operations Map & Geographic Quality. Reuse explicit survey/attendance/case coordinates, preserve location privacy and do not introduce continuous worker tracking.',
