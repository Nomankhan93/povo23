...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.19.1 PRODUCT BOUNDARIES =====',
    '- One personal POEM account can access multiple authorized workspaces.',
    '- 2.19.0 adds project/person-scoped beneficiary cases and assistance requests between assessed needs and delivered assistance; 2.19.1 adds planning-only assistance_distribution_plans after approved requests.',
    '- Case intake requires approved survey provenance; one assessed need can belong to only one active case at a time.',
    '- POEM survey authority, NGO Admin and Project Manager manage cases/requests and 2.19.1 distribution plans; only NGO Admin / POEM survey authority approve or reject requests. Area Focal remains outside the case/planning boundary.',
    '- Assistance-request approval means approved for planning only. A 2.19.1 plan may be draft, scheduled, ready or cancelled; none of those states creates assistance_entries, payment, eligibility or impact claims.',
    ...
    '2.19.2 — Assistance Ledger & Duplicate-Support Controls should connect controlled execution/ledger workflows to existing assistance_entries and canonical identity without broad cross-NGO exposure.',
    '2.19.3 should add follow-up, outcomes and case closure after assistance execution semantics are established.',
