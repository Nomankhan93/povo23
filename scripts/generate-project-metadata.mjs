...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '2.20.0 completes the Field Worker daily workspace, 2.21.0 the Organization workspace, 2.22.0 the FieldLance Staff Operations Home, and 2.23.0 the shared Tasks / SLA / Escalation Center.',
    'The next development phase is 2.24 Notifications & Communication Center. Keep task notifications event-driven and provider integrations deferred until official credentials are available.',
