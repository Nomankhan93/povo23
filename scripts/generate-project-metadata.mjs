...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CONSOLIDATED 2.13.x PRODUCT BOUNDARIES =====',
    ...
    '- Automatic volunteer performance levels/ranking and Project Manager/Area Focal Person roles do not yet exist.',
    '',
    '===== DATABASE BASELINE =====',
    ...
    '2.14 — Project Team & Area Governance.',
    'Build project-scoped Project Manager / Area Focal Person authorization together with reliable collection/operational geography so area isolation can be enforced by database/RLS rather than UI filters.',
    'Extend existing organization/project/workforce primitives. Do not introduce parallel recruitment, template, work-history or payable systems.',
    '',
