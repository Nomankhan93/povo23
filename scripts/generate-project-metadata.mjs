...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.14.2 PRODUCT BOUNDARIES =====',
    ...
    '- Project Manager and Area Focal Person workspaces now include RLS-filtered operational metrics, area coverage, recent response queues and direct review navigation; broad NGO administration remains separate.',
    '',
    '===== DATABASE BASELINE =====',
    ...
    '2.15 — NGO Template & Project Self-Service should extend the existing template draft/project primitives.',
    'Keep 2.14 project staff / collection-geography authorization as the operational boundary for later project workflows.',
