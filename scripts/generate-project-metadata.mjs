...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.30.1 PRODUCT BOUNDARIES =====',
    ...
    'FieldLance 2.30.1 stabilizes the project workspace over the existing authorization and finance/case/survey architecture.',
    'The next recommended phase is 2.31 URL Routing, Deep Links & Mobile Information Architecture: bookmarkable project/case/notification destinations, natural browser history, and a mobile-first Field Worker bottom navigation without changing backend authority.',
