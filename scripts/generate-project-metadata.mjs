...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.17.0 PRODUCT BOUNDARIES =====',
    ...
    '- Existing worker payable tables remain a separate entitlement subledger; no payable-to-finance bridge, project funding/reservation or provider settlement is included in 2.17.0.',
    '- Generic finance mutation is POEM admin/super-admin only; NGO Admin read access is organization-scoped and project operational roles do not inherit finance authority.',
    '',
    '===== DATABASE BASELINE =====',
    ...
    '2.17.1 — Project Funding & Reservation should add constrained NGO/project funding and reservation actions on top of the 2.17.0 double-entry finance core.',
    'Keep 2.14 project staff / collection-geography authorization as the operational boundary for approved project workflows.',
    '2.17.2 should bridge existing payable events into finance journals idempotently; do not duplicate worker entitlement calculations.',
