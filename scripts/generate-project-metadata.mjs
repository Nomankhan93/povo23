...
function generateAnalysisContext(files) {
  ...
  const lines = [
    ...
    '',
    '===== CURRENT 2.17.2 PRODUCT BOUNDARIES =====',
    ...
    '- Worker payable accounting, verified organization funding, project reservation and payable-to-finance reconciliation exist; payment-provider custody/transfer remains outside the baseline.',
    ...
    '2.18 — Provider Funding & Withdrawals should add verified provider callbacks/clearing and payout reconciliation on top of the immutable 2.17 finance ledger.',
    'Keep 2.14 project staff / collection-geography authorization as the operational boundary for approved project workflows.',
    'Keep project funding/reservation and payable reconciliation on constrained finance RPCs; do not widen generic finance posting to NGO or project staff.',
