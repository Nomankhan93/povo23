...
const workspaceGroups: Record<WorkspaceKind, readonly NavigationGroup[]> = {
  ...
  staff: [
    {label:'Overview',pages:overview},
    {label:'Organizations & people',pages:['Partner NGOs','NGO applications','Volunteers','Reputation & Certificates','Organization Settings','Verification']},
  ...
  project: [
    {label:'Overview',pages:overview},
    {label:'Delivery',pages:['Survey projects','Recruitment','Project team','Project governance','Project funding']},
    {label:'Impact operations',pages:impact},
    {label:'Administration',pages:['Activity']},
  ],
