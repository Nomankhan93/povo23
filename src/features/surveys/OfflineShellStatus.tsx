...
export function OfflineShellStatus(){
 ...
 useEffect(()=>{
   ...
   const check=async()=>{
     ...
     if(live)setText(reg?.waiting?'An app update is waiting. Finish sync and close all POEM tabs before reopening.':reg?.active?'Offline app files installed. Download your assigned projects before leaving connectivity.':'App files are not installed yet. Stay online and reload once before field use.');
   };
